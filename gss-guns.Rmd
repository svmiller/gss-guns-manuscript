...
runhead: "What Americans Really Think About Gun Control"
# subtitle: 
...
abstract: "Gun control is one of the most controversial public opinion debates in the United States for which conventional wisdom suggests mass polarization on the topic leads to policy gridlock. My analysis of 28 waves of General Social Survey data shows this is wrong and generates four key findings: 1) GOP partisanship does not robustly reduce support for gun control; 2) most 'strong' Republicans actually support gun control; 3) polarization of attitudes about gun control is only partial and recent; and 4) our casual assumptions about regional variation in attitudes toward gun control need re-evaluation. I conclude with a discussion of the differences we observe between elite polarization and mass polarization and with implications for the future of gun control advocacy."
fontfamily: mathpazo
